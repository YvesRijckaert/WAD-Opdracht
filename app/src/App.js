  ...
  render() {
    ...
    return (
      <div className="App">
          ...
          <Route
            ...
            render={() => (
              <WorkTable
                ...
                table={table}
                onClickAddToTotal={this.handleClickToTotal}
              />
            )}
          />
          <Route
            ...
            render={() => (
              <WorkPlaces
                workPlaces={workPlaces}
                onAddToTable={this.handleAddItem}
                onChangeWorkPlace={this.handleChangeWorkPlace}
                onDeleteWorkPlace={this.handleDeleteWorkPlace}
              />
            )}
          />
        ...
        <TotalHours
          totalHours={total}
          totalAmount="currency calculator from total here"
        />
      </div>
    );
  }
